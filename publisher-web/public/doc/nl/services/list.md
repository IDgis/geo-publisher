...
>In een vorige stap heeft u een laag aangemaakt. In de volgende stappen gaat u een service maken, de laag toevoegen en publiveren.
...
4) Klik op **Opslaan**, uw service is aangemaakt, maar nog niet gepubliceerd. Dit gebeurt in de volgende stap.
